...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return publicMetadata(
    settings,
    "Modalidades",
    "Conheça as modalidades e encontre o treino certo para seu objetivo.",
  );
}
  ...
  return (
    <main className="page-hero">
      <div className="container">
        ...
        <h1>MODALIDADES</h1>
        <p className="muted">
          Escolha o estímulo que combina com seu objetivo.
        </p>
        <div className="grid grid-3 page-grid">
          {modalities.map((item) => (
            ...
            >
              ...
              />
              <h2>{item.name}</h2>
              <p className="muted">{item.description || item.summary}</p>
              <small>
