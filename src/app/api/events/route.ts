...
const schema = z.object({
  name: z.enum(["page_view", "whatsapp_click", "plan_click", "trial_class_started", "lead_submitted", "contact_started"]),
...
export async function POST(request: NextRequest) {
  ...
  if (!(await rateLimit("analytics:" + hashValue(ip), LIMITS.analytics.limit, LIMITS.analytics.window))) {
