...
export default async function AdminLeads() {
  ...
  return (
    <section>
      <div className="admin-heading"><span>CRM</span><h1>Leads</h1></div>
      <div className="admin-table">
        <div className="admin-row admin-row-head"><strong>Nome</strong><span>WhatsApp</span><span>Status</span><span>Origem</span></div>
